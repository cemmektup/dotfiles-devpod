...
vim.api.nvim_set_keymap("n", "<leader>yy", ":call system('nc localhost 12345', @0)<CR>", { noremap = true })
vim.api.nvim_set_keymap("v", "<leader>yy", ":call system('nc localhost 12345', @0)<CR>", { noremap = true })
